import { Check, ChevronDown, ChevronUp, PackageOpen } from 'lucide-react-native';
import { useMemo, useState } from 'react';
import { useColorScheme } from 'react-native';
import type { FontSizeTokens, SelectProps } from 'tamagui';
import { Text, Input, Adapt, Select, Sheet, YStack, getFontSize, View } from 'tamagui';
...
const SelectItem: React.FC<CustomSelectProps> = (
  { id, placeholder, label, items, val, setVal },
  props
) => {
  ...
  return (
    <Select id={id} value={val} onValueChange={setVal} disablePreventBodyScroll {...props}>
      <Select.Trigger borderWidth="$1" iconAfter={<ChevronDown />}>
